...
pomExtra :=
  <url>https://github.com/hypertino/hyperbus-consul-resolver</url>
    <licenses>
      <license>
        <name>BSD-style</name>
    ...
    <scm>
      <url>git@github.com:hypertino/hyperbus-consul-resolver.git</url>
      <connection>scm:git:git@github.com:hypertino/hyperbus-consul-resolver.git</connection>
    </scm>
    <developers>
      <developer>
        <id>maqdev</id>
